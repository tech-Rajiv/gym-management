 ...
 *
 * The search term is passed as a parameter and tested with `IS NULL OR ...`
 * rather than building the WHERE clause as a string. One query text covers
 * both cases and the value can never be read as SQL.
 */
